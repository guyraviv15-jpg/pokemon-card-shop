        ...
        <div>
          ...
          <div className="border-t border-gray-200 pt-6">
            <div className="flex items-baseline gap-2 mb-4">
              ...
              {card.quantity > 0 ? (
                <span className="text-sm text-gray-500">{card.quantity} available</span>
              ) : (
            ...
            >
              {card.quantity > 0 ? 'Contact to Purchase' : 'Sold Out'}
            </button>
            <p className="text-xs text-gray-400 mt-2 text-center">
              This is a listing site. Contact the seller to make a purchase.
            </p>
          </div>
        </div>
      </div>
